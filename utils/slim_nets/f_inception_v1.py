...
def inception_v1_base(inputs,
  ...
  """
  end_points = {}
  with tf.variable_scope(scope, 'f_InceptionV1', [inputs]):
    with slim.arg_scope(
...
def inception_v1(inputs,
  ...
  with tf.variable_scope(scope, 'f_InceptionV1', [inputs, num_classes],
...
def inception_v1_arg_scope(weight_decay=0.00004,
  ...
  """Defines the default f_InceptionV1 arg scope.
